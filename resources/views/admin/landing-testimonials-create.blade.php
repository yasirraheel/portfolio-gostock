...
@section('title', 'Add Landing Testimonial')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-0">
                            <i class="bi bi-plus-circle me-2"></i>Add New Landing Testimonial
                        </h4>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('panel/admin/landing-testimonials/create') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('testimonial_text') is-invalid @enderror" 
                                      ...
                                      placeholder="Enter the testimonial text..." required>{{ old('testimonial_text') }}</textarea>
