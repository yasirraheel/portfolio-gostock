...
@section('title') {{__('misc.add_custom_section')}} - @endsection
			...
			<div class="col-md-9">
				...
				<div class="card shadow-custom border-0">
					<div class="card-body p-lg-4">
						<div class="row align-items-center mb-4">
							<div class="col-lg-6">
								<h4 class="mb-0">{{__('misc.add_custom_section')}}</h4>
						...
						<form action="{{ url('user/custom-section/store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card shadow-sm mb-4">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-floating mb-3">
                              <input type="text" name="title" class="form-control" id="title" placeholder="{{__('misc.section_title')}}" required value="{{ old('title') }}">
                          ...
                          <div class="col-lg-6">
                            <div class="form-floating mb-3">
                              <input type="number" name="order_position" class="form-control" id="order_position" placeholder="{{__('misc.order_position')}}" value="{{ old('order_position', 0) }}" min="0">
                            ...
                            <div class="form-floating mb-3">
                              <select name="icon" class="form-control" id="icon">
                                ...
                                <optgroup label="{{__('misc.general_icons')}}">
                                  <option value="fas fa-cube" {{ old('icon') == 'fas fa-cube' ? 'selected' : '' }}>📦 Cube</option>
                                ...
                                <optgroup label="{{__('misc.business_icons')}}">
                                  ...
                                  <option value="fas fa-bullseye" {{ old('icon') == 'fas fa-bullseye' ? 'selected' : '' }}>🎯 Target</option>
                                </optgroup>
                                ...
                                <optgroup label="{{__('misc.creative_icons')}}">
                                  ...
                                  <option value="fas fa-paint-brush" {{ old('icon') == 'fas fa-paint-brush' ? 'selected' : '' }}>🖌️ Brush</option>
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-floating mb-3">
                              <textarea name="content" class="form-control" id="content" placeholder="{{__('misc.section_content')}}" style="height: 150px;" required>{{ old('content') }}</textarea>
                    ...
                    <div class="card shadow-sm mb-4">
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-floating mb-3">
                              <input type="url" name="link_url" class="form-control" id="link_url" placeholder="{{__('misc.section_link_url')}}" value="{{ old('link_url') }}">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-floating mb-3">
                              <input type="text" name="link_text" class="form-control" id="link_text" placeholder="{{__('misc.section_link_text')}}" value="{{ old('link_text') }}">
                ...
                <div class="text-center mt-4">
                  <button type="submit" class="btn btn-custom btn-lg">
                    <i class="fas fa-save me-1"></i> {{__('misc.save_custom_section')}}
                  </button>
                </div>
