...
@section('title') {{ __('misc.edit_experience') }} - @endsection
			...
			<div class="col-md-9">
				...
				<div class="card shadow-custom border-0">
					<div class="card-body p-lg-4">
						<div class="row">
							<div class="col-lg-6">
								<h4 class="mb-0">{{ __('misc.edit_experience') }}</h4>
								<small class="text-muted">{{ __('misc.update_experience_information') }}</small>
							</div>
				...
				<div class="card shadow-custom border-0 mt-3">
					<div class="card-body p-lg-4">
						<form method="POST" action="{{ route('user.experience.update') }}" enctype="multipart/form-data">
							@csrf
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="text" name="company_name" class="form-control @error('company_name') is-invalid @enderror" placeholder="Google, Microsoft" required id="company_name" value="{{ old('company_name', $experience->company_name) }}">
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="text" name="job_title" class="form-control @error('job_title') is-invalid @enderror" placeholder="Senior Software Engineer" required id="job_title" value="{{ old('job_title', $experience->job_title) }}">
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<select name="employment_type" class="form-select @error('employment_type') is-invalid @enderror" required id="employment_type">
											<option value="full_time" {{ old('employment_type', $experience->employment_type) == 'full_time' ? 'selected' : '' }}>{{ __('misc.full_time') }}</option>
											<option value="part_time" {{ old('employment_type', $experience->employment_type) == 'part_time' ? 'selected' : '' }}>{{ __('misc.part_time') }}</option>
											<option value="contract" {{ old('employment_type', $experience->employment_type) == 'contract' ? 'selected' : '' }}>{{ __('misc.contract') }}</option>
											<option value="freelance" {{ old('employment_type', $experience->employment_type) == 'freelance' ? 'selected' : '' }}>{{ __('misc.freelance') }}</option>
											<option value="internship" {{ old('employment_type', $experience->employment_type) == 'internship' ? 'selected' : '' }}>{{ __('misc.internship') }}</option>
											<option value="temporary" {{ old('employment_type', $experience->employment_type) == 'temporary' ? 'selected' : '' }}>{{ __('misc.temporary') }}</option>
										</select>
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="text" name="location" class="form-control @error('location') is-invalid @enderror" placeholder="New York, Remote" id="location" value="{{ old('location', $experience->location) }}">
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="url" name="company_website" class="form-control @error('company_website') is-invalid @enderror" placeholder="https://company.com" id="company_website" value="{{ old('company_website', $experience->company_website) }}">
												...
												<div id="companyLogoPreview" style="width: 80px; height: 80px; margin: 0 auto; position: relative;">
													@if($experience->company_logo)
														...
														<div class="bg-light rounded mb-2 align-items-center justify-content-center placeholder-div"
															 style="width: 80px; height: 80px; display: none; position: absolute; top: 0; left: 0;">
							...
							<div class="row">
								<div class="col-md-4 mb-3">
									<div class="form-floating">
										<input type="date" name="start_date" class="form-control @error('start_date') is-invalid @enderror" required id="start_date" value="{{ old('start_date', $experience->start_date ? $experience->start_date->format('Y-m-d') : '') }}">
								...
								<div class="col-md-4 mb-3">
									<div class="form-check mt-4">
										<input class="form-check-input" type="checkbox" name="is_current" id="is_current" value="1" {{ old('is_current', $experience->is_current) ? 'checked' : '' }}>
							...
							<div class="row">
								<div class="col-12 mb-3">
									<div class="form-floating">
										<textarea name="description" class="form-control @error('description') is-invalid @enderror" style="height: 100px;" placeholder="Describe your role and responsibilities..." id="description">{{ old('description', $experience->description) }}</textarea>
								...
								<div class="col-12 mb-3">
									<div class="form-floating">
										<input type="text" name="technologies_used" class="form-control @error('technologies_used') is-invalid @enderror" placeholder="JavaScript, React, Node.js, Python (comma separated)" id="technologies_used" value="{{ old('technologies_used', $experience->technologies_used) }}">
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<select name="status" class="form-select @error('status') is-invalid @enderror" required id="status">
											<option value="active" {{ old('status', $experience->status) == 'active' ? 'selected' : '' }}>{{ __('misc.active') }}</option>
											<option value="inactive" {{ old('status', $experience->status) == 'inactive' ? 'selected' : '' }}>{{ __('misc.inactive') }}</option>
										</select>
							...
							<div class="row">
								<div class="col-md-12">
									<button type="submit" class="btn btn-custom me-2">
										<i class="bi bi-check2 me-1"></i>{{ __('misc.update_experience') }}
									</button>
