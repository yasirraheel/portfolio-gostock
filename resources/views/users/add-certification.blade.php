...
@section('title') {{ __('misc.add_certification') }} - @endsection
			...
			<div class="col-md-9">
				...
				<div class="card shadow-custom border-0">
					<div class="card-body p-lg-4">
						<div class="row">
							<div class="col-lg-6">
								<h4 class="mb-0">{{ __('misc.add_certification') }}</h4>
								<small class="text-muted">{{ __('misc.add_your_professional_certification') }}</small>
							</div>
				...
				<div class="card shadow-custom border-0 mt-3">
					<div class="card-body p-lg-4">
						<form method="POST" action="{{ route('user.certification.store') }}" enctype="multipart/form-data">
							@csrf
								...
								<div class="col-md-6">
									<div class="form-floating mb-3">
										<input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
											   value="{{ old('name') }}" required id="name" placeholder="AWS Certified Solutions Architect">
								...
								<div class="col-md-6">
									<div class="form-floating mb-3">
										<input type="text" name="issuing_organization" class="form-control @error('issuing_organization') is-invalid @enderror"
											   value="{{ old('issuing_organization') }}" required id="issuing_organization" placeholder="Amazon Web Services">
								...
								<div class="col-md-6">
									<div class="form-floating mb-3">
										<input type="date" name="issue_date" class="form-control @error('issue_date') is-invalid @enderror"
											   value="{{ old('issue_date') }}" required id="issue_date">
							...
							<div class="form-check form-switch form-switch-md mb-3">
								<input class="form-check-input" type="checkbox" name="does_not_expire"
									   id="does_not_expire" value="1" {{ old('does_not_expire') ? 'checked' : '' }}>
								<label class="form-check-label" for="does_not_expire">
									{{ __('misc.does_not_expire') }}
								</label>
								<small class="text-muted d-block">{{ __('misc.no_expiry') }}</small>
							</div>
								...
								<div class="col-md-6">
									<div class="form-floating mb-3">
										<input type="text" name="credential_id" class="form-control @error('credential_id') is-invalid @enderror"
											   value="{{ old('credential_id') }}" id="credential_id" placeholder="CERT-2024-123456">
								...
								<div class="col-md-6">
									<div class="form-floating mb-3">
										<input type="url" name="credential_url" class="form-control @error('credential_url') is-invalid @enderror"
											   value="{{ old('credential_url') }}" id="credential_url" placeholder="https://verify.example.com/credential/123">
							...
							<div class="form-floating mb-3">
								<textarea name="description" class="form-control @error('description') is-invalid @enderror"
										  style="height: 120px" id="description" placeholder="{{ __('misc.describe_your_certification') }}">{{ old('description') }}</textarea>
							...
							<div class="form-floating mb-3">
								<textarea name="skills_gained" class="form-control @error('skills_gained') is-invalid @enderror"
										  style="height: 80px" id="skills_gained" placeholder="{{ __('misc.skills_gained_from_certification') }}">{{ old('skills_gained') }}</textarea>
								...
								<div class="col-md-6">
									<div class="mb-4">
										...
										<small class="d-block text-muted">
											<i class="bi bi-info-circle me-1"></i>{{ __('misc.max_file_size_2mb') }}
										</small>
							...
							<div class="d-flex gap-2">
								<button type="submit" class="btn btn-custom">
									<i class="bi bi-check2 me-1"></i>{{ __('misc.save_certification') }}
								</button>
