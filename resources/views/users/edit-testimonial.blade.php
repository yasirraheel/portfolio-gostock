...
@section('title') {{ __('misc.edit_testimonial') }} - @endsection
			...
			<div class="col-md-9">
				...
				<div class="card shadow-custom border-0">
					<div class="card-body p-lg-4">
						<div class="row">
							<div class="col-lg-6">
								<h4 class="mb-0">{{ __('misc.edit_testimonial') }}</h4>
								<small class="text-muted">{{ __('misc.edit_client_testimonial') }}</small>
							</div>
				...
				<div class="card shadow-custom border-0 mt-3">
					<div class="card-body p-lg-4">
						<form method="POST" action="{{ route('user.testimonial.update') }}" enctype="multipart/form-data">
							@csrf
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="text" name="client_name" id="client_name" class="form-control @error('client_name') is-invalid @enderror" value="{{ old('client_name', $testimonial->client_name) }}" placeholder="{{ __('misc.client_name') }}" required>
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="text" name="client_position" id="client_position" class="form-control @error('client_position') is-invalid @enderror" value="{{ old('client_position', $testimonial->client_position) }}" placeholder="{{ __('misc.client_position') }}">
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="text" name="company_name" id="company_name" class="form-control @error('company_name') is-invalid @enderror" value="{{ old('company_name', $testimonial->company_name) }}" placeholder="{{ __('misc.company_name') }}">
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="url" name="client_website" id="client_website" class="form-control @error('client_website') is-invalid @enderror" value="{{ old('client_website', $testimonial->client_website) }}" placeholder="{{ __('misc.client_website') }}">
							...
							<div class="row">
								<div class="col-md-12 mb-3">
									<div class="form-floating">
										<textarea name="testimonial_text" id="testimonial_text" class="form-control @error('testimonial_text') is-invalid @enderror" placeholder="{{ __('misc.testimonial_text') }}" style="height: 120px;" required>{{ old('testimonial_text', $testimonial->testimonial_text) }}</textarea>
								...
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="date" name="date_received" id="date_received" class="form-control @error('date_received') is-invalid @enderror" value="{{ old('date_received', $testimonial->date_received) }}" placeholder="{{ __('misc.date_received') }}">
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									<div class="form-floating">
										<input type="text" name="project_type" id="project_type" class="form-control @error('project_type') is-invalid @enderror" value="{{ old('project_type', $testimonial->project_type) }}" placeholder="{{ __('misc.project_type') }}">
								...
								<div class="col-md-12 mb-3">
									<div class="form-floating">
										<textarea name="project_details" id="project_details" class="form-control @error('project_details') is-invalid @enderror" placeholder="{{ __('misc.project_details') }}" style="height: 100px;">{{ old('project_details', $testimonial->project_details) }}</textarea>
								...
								<div class="col-md-12 mb-3">
									<div class="form-floating">
										<select name="status" id="status" class="form-select @error('status') is-invalid @enderror" required>
											<option value="active" {{ old('status', $testimonial->status ?? 'active') == 'active' ? 'selected' : '' }}>{{ __('misc.active') }}</option>
											<option value="inactive" {{ old('status', $testimonial->status) == 'inactive' ? 'selected' : '' }}>{{ __('misc.inactive') }}</option>
										</select>
							...
							<div class="row">
								<div class="col-md-12 text-end">
									<button type="submit" class="btn btn-custom btn-lg">
										<i class="fas fa-save me-1"></i> {{ __('misc.update_testimonial') }}
									</button>
								</div>
							</div>
						</form>
